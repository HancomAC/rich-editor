...
function PdfBlockView({ node, deleteNode, selected }) {
  ...
  return /* @__PURE__ */ jsx(NodeViewWrapper, { className: "my-4", contentEditable: false, "data-drag-handle": true, children: /* @__PURE__ */ jsxs("div", { className: "border rounded-lg overflow-hidden bg-muted/30 transition-shadow", style: {
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between px-4 py-2 border-b border-border bg-background", children: [
      /* @__PURE__ */ jsx("span", { className: "text-xs text-muted-foreground truncate max-w-[200px]", children: name || "PDF \uBB38\uC11C" }),
    ...
    loading2 && /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center p-8", children: /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground animate-pulse", children: "PDF \uB85C\uB529 \uC911..." }) }),
    error && /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center p-8 gap-2", children: [
      /* @__PURE__ */ jsx("p", { className: "text-sm text-muted-foreground", children: "PDF\uB97C \uBD88\uB7EC\uC62C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4." }),
      /* @__PURE__ */ jsx("a", { href: src, target: "_blank", rel: "noopener noreferrer", className: "text-sm text-primary hover:underline", children: "\uC9C1\uC811 \uB2E4\uC6B4\uB85C\uB4DC" })
    ] }),
    !loading2 && !error && /* @__PURE__ */ jsxs(Fragment2, { children: [
      /* @__PURE__ */ jsx("div", { ref: containerRef, className: "flex items-center justify-center p-4 bg-neutral-100 dark:bg-neutral-900", children: /* @__PURE__ */ jsx("canvas", { ref: canvasRef, className: "shadow-sm" }) }),
      total > 1 && /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-center gap-4 px-4 py-2 border-t border-border bg-background", children: [
        /* @__PURE__ */ jsx(
          "button",
          {
            type: "button",
...
// src/extensions/PdfBlock.ts
var PdfBlock = TiptapNode.create({
  name: "pdfBlock",
  group: "block",
  atom: true,
  addAttributes() {
...
function InputModal({
  ...
  return /* @__PURE__ */ jsx2("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/30", onClick: onCancel, children: /* @__PURE__ */ jsxs2(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs2("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsx2("span", { className: "text-sm font-medium", children: title }),
          /* @__PURE__ */ jsx2(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxs2("div", { className: "flex justify-end gap-2 mt-3", children: [
          /* @__PURE__ */ jsx2(
            "button",
            {
              type: "button",
...
function Sep() {
  return /* @__PURE__ */ jsx3("div", { className: "w-px h-6 bg-border mx-0.5" });
}
...
function FixedToolbar({ editor, onPdfClick }) {
  const iconSize = 16;
  const [codeMenuOpen, setCodeMenuOpen] = useState3(false);
  const [tableMenuOpen, setTableMenuOpen] = useState3(false);
  const [modalState, setModalState] = useState3(null);
  const codeMenuRef = useRef3(null);
  const tableMenuRef = useRef3(null);
  useEffect3(() => {
  ...
  const runTableCommand = useCallback2(
    (command) => {
      command();
      setTableMenuOpen(false);
    },
  ...
  return /* @__PURE__ */ jsxs3("div", { className: "sticky top-[74px] z-10 flex flex-wrap items-center gap-0.5 px-3 py-2 border-b border-border bg-background rounded-t-xl", style: { top: "var(--header-height, 74px)" }, children: [
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uAD75\uAC8C",
        children: /* @__PURE__ */ jsx3(Bold, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uAE30\uC6B8\uC784",
        children: /* @__PURE__ */ jsx3(Italic, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uBC11\uC904",
        children: /* @__PURE__ */ jsx3(UnderlineIcon, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uCDE8\uC18C\uC120",
        children: /* @__PURE__ */ jsx3(Strikethrough, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uD558\uC774\uB77C\uC774\uD2B8",
        children: /* @__PURE__ */ jsx3(Highlighter, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uC704\uCCA8\uC790",
        children: /* @__PURE__ */ jsx3(Superscript, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uC544\uB798\uCCA8\uC790",
        children: /* @__PURE__ */ jsx3(Subscript, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(Sep, {}),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uC67C\uCABD \uC815\uB82C",
        children: /* @__PURE__ */ jsx3(AlignLeft, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uAC00\uC6B4\uB370 \uC815\uB82C",
        children: /* @__PURE__ */ jsx3(AlignCenter, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uC624\uB978\uCABD \uC815\uB82C",
        children: /* @__PURE__ */ jsx3(AlignRight, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(Sep, {}),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uC81C\uBAA9 1",
        children: /* @__PURE__ */ jsx3(Heading1, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uC81C\uBAA9 2",
        children: /* @__PURE__ */ jsx3(Heading2, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uC81C\uBAA9 3",
        children: /* @__PURE__ */ jsx3(Heading3, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(Sep, {}),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uAE00\uBA38\uB9AC \uBAA9\uB85D",
        children: /* @__PURE__ */ jsx3(List, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uBC88\uD638 \uBAA9\uB85D",
        children: /* @__PURE__ */ jsx3(ListOrdered, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8",
        children: /* @__PURE__ */ jsx3(CheckSquare, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uC778\uC6A9\uBB38",
        children: /* @__PURE__ */ jsx3(Quote, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
    ...
    /* @__PURE__ */ jsx3(Btn, { onClick: onPdfClick, title: "PDF \uC0BD\uC785", children: /* @__PURE__ */ jsx3(FileText, { size: iconSize }) }),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        onClick: () => {
        ...
        title: "YouTube \uC601\uC0C1",
        children: /* @__PURE__ */ jsx3(Youtube, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsxs3("div", { ref: tableMenuRef, className: "relative", children: [
      /* @__PURE__ */ jsxs3(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsx3(TableIcon, { size: iconSize }),
            /* @__PURE__ */ jsx3(ChevronDown, { size: 12 })
          ]
        }
      ),
      tableMenuOpen && /* @__PURE__ */ jsx3("div", { className: "absolute top-full left-0 mt-1 bg-popover border border-border rounded-lg shadow-lg z-20 py-1", style: { minWidth: "220px" }, children: !isInTable ? /* @__PURE__ */ jsxs3(Fragment3, { children: [
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(TableIcon, { size: 14 }),
            label: "\uD45C \uC0BD\uC785 (3x3)",
        ...
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(PanelTop, { size: 14 }),
            label: "\uD5E4\uB354 \uD3EC\uD568 4x4",
            onClick: () => runTableCommand(
        ...
        /* @__PURE__ */ jsx3("p", { className: "px-3 py-1 text-[10px] font-medium uppercase tracking-wider text-muted-foreground", children: "\uAD6C\uC870" }),
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(Rows3, { size: 14 }),
            label: "\uD589 \uC704\uC5D0 \uCD94\uAC00",
        ...
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(Columns3, { size: 14 }),
            label: "\uC5F4 \uC67C\uCABD\uC5D0 \uCD94\uAC00",
        ...
        /* @__PURE__ */ jsx3("div", { className: "h-px bg-border my-1" }),
        /* @__PURE__ */ jsx3("p", { className: "px-3 py-1 text-[10px] font-medium uppercase tracking-wider text-muted-foreground", children: "\uD5E4\uB354 / \uC140" }),
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(PanelTop, { size: 14 }),
        ...
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(PanelLeft, { size: 14 }),
            label: "\uD5E4\uB354 \uC5F4 \uD1A0\uAE00",
        ...
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(Combine, { size: 14 }),
            label: "\uC140 \uBCD1\uD569",
        ...
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(SplitSquareHorizontal, { size: 14 }),
            label: "\uC140 \uBD84\uD560",
        ...
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(Paintbrush, { size: 14 }),
            label: "\uC140 \uBC30\uACBD\uC0C9",
            onClick: () => {
              setTableMenuOpen(false);
        ...
        /* @__PURE__ */ jsx3("div", { className: "h-px bg-border my-1" }),
        /* @__PURE__ */ jsx3("p", { className: "px-3 py-1 text-[10px] font-medium uppercase tracking-wider text-muted-foreground", children: "\uC0AD\uC81C" }),
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(Rows3, { size: 14 }),
        ...
        /* @__PURE__ */ jsx3(
          TableMenuButton,
          {
            icon: /* @__PURE__ */ jsx3(Trash22, { size: 14 }),
            label: "\uD45C \uC0AD\uC81C",
            destructive: true,
    ...
    /* @__PURE__ */ jsxs3("div", { ref: codeMenuRef, className: "relative", children: [
      /* @__PURE__ */ jsxs3(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ jsx3(Code2, { size: iconSize }),
            /* @__PURE__ */ jsx3(ChevronDown, { size: 12 })
          ]
        }
      ),
      codeMenuOpen && /* @__PURE__ */ jsxs3("div", { className: "absolute top-full left-0 mt-1 bg-popover border border-border rounded-lg shadow-lg z-20 py-1", style: { minWidth: "130px" }, children: [
        /* @__PURE__ */ jsx3(
          "button",
          {
            type: "button",
    ...
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uC2E4\uD589 \uCDE8\uC18C",
        children: /* @__PURE__ */ jsx3(Undo, { size: iconSize })
      }
    ),
    /* @__PURE__ */ jsx3(
      Btn,
      {
        ...
        title: "\uB2E4\uC2DC \uC2E4\uD589",
        children: /* @__PURE__ */ jsx3(Redo, { size: iconSize })
      }
    ),
    modalState?.type === "link" && /* @__PURE__ */ jsx3(
      InputModal,
      {
        title: "\uB9C1\uD06C URL \uC785\uB825",
    ...
    modalState?.type === "image" && /* @__PURE__ */ jsx3(
      InputModal,
      {
        title: "\uC774\uBBF8\uC9C0 URL \uC785\uB825",
    ...
    modalState?.type === "cellBg" && /* @__PURE__ */ jsx3("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/30", onClick: () => setModalState(null), children: /* @__PURE__ */ jsxs3("div", { className: "bg-popover border border-border rounded-xl shadow-lg p-4", style: { minWidth: "240px" }, onClick: (e) => e.stopPropagation(), children: [
      /* @__PURE__ */ jsx3("p", { className: "text-sm font-semibold mb-3", children: "\uC140 \uBC30\uACBD\uC0C9" }),
      /* @__PURE__ */ jsx3("div", { className: "grid grid-cols-3 gap-2", children: [
        { label: "\uC5C6\uC74C", value: "" },
...
var SLASH_MENU_ITEMS = [
  {
    ...
    icon: /* @__PURE__ */ jsx4(Heading12, { size: SI }),
    command: (editor) => editor.chain().focus().toggleHeading({ level: 1 }).run()
  },
  {
    label: "\uC81C\uBAA9 2",
    keywords: "heading h2 \uC81C\uBAA9",
    icon: /* @__PURE__ */ jsx4(Heading22, { size: SI }),
    command: (editor) => editor.chain().focus().toggleHeading({ level: 2 }).run()
  },
  {
    label: "\uC81C\uBAA9 3",
    keywords: "heading h3 \uC81C\uBAA9",
    icon: /* @__PURE__ */ jsx4(Heading32, { size: SI }),
    command: (editor) => editor.chain().focus().toggleHeading({ level: 3 }).run()
  },
  {
    label: "\uAE00\uBA38\uB9AC \uBAA9\uB85D",
    keywords: "bullet list \uBAA9\uB85D \uB9AC\uC2A4\uD2B8",
    icon: /* @__PURE__ */ jsx4(List2, { size: SI }),
    command: (editor) => editor.chain().focus().toggleBulletList().run()
  },
  {
    label: "\uBC88\uD638 \uBAA9\uB85D",
    keywords: "ordered number list \uBC88\uD638 \uB9AC\uC2A4\uD2B8",
    icon: /* @__PURE__ */ jsx4(ListOrdered2, { size: SI }),
    command: (editor) => editor.chain().focus().toggleOrderedList().run()
  },
  {
    label: "\uCCB4\uD06C\uB9AC\uC2A4\uD2B8",
    keywords: "checklist task todo \uCCB4\uD06C \uD560\uC77C",
    icon: /* @__PURE__ */ jsx4(CheckSquare2, { size: SI }),
    command: (editor) => editor.chain().focus().toggleTaskList().run()
  },
  {
    label: "\uC778\uC6A9\uBB38",
    keywords: "quote blockquote \uC778\uC6A9",
    icon: /* @__PURE__ */ jsx4(Quote2, { size: SI }),
    command: (editor) => editor.chain().focus().toggleBlockquote().run()
  },
  {
    label: "\uAD6C\uBD84\uC120",
    keywords: "divider hr horizontal rule \uAD6C\uBD84",
    icon: /* @__PURE__ */ jsx4(Minus2, { size: SI }),
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(TableIcon2, { size: SI }),
    command: (editor) => editor.chain().focus().insertTable({ rows: 3, cols: 3, withHeaderRow: true }).run()
  },
  {
    label: "YouTube \uC601\uC0C1",
    keywords: "youtube video \uC601\uC0C1 \uB3D9\uC601\uC0C1 \uC720\uD29C\uBE0C",
    icon: /* @__PURE__ */ jsx4(Youtube2, { size: SI }),
    command: (editor) => {
      const url = window.prompt("YouTube URL\uC744 \uC785\uB825\uD558\uC138\uC694");
      if (url) editor.chain().focus().setYoutubeVideo({ src: url }).run();
    }
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(ImageIcon2, { size: SI }),
    command: (editor) => {
  ...
  },
  {
    ...
    icon: /* @__PURE__ */ jsx4(LinkIcon2, { size: SI }),
    command: (editor) => {
...
function SlashCommandMenu({
  ...
  const allItems = onPdfUpload ? [
    ...SLASH_MENU_ITEMS,
    {
      label: "PDF \uD30C\uC77C",
      keywords: "pdf \uD30C\uC77C \uBB38\uC11C",
      icon: /* @__PURE__ */ jsx4(FileText2, { size: SI }),
      command: () => onPdfUpload()
    }
  ] : SLASH_MENU_ITEMS;
  ...
  if (filtered.length === 0) {
    return /* @__PURE__ */ jsx4(
      "div",
      {
        ...
        style: { width: "180px" },
        children: /* @__PURE__ */ jsx4("p", { className: "text-xs text-muted-foreground px-2 py-1", children: "\uACB0\uACFC \uC5C6\uC74C" })
      }
    );
  }
  return /* @__PURE__ */ jsxs4(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx4("p", { className: "text-[10px] font-medium text-muted-foreground uppercase tracking-wider px-3 py-1.5", children: "\uBE14\uB85D" }),
        filtered.map((item, i) => /* @__PURE__ */ jsxs4(
          "button",
          {
            type: "button",
            "data-index": i,
            ...
            children: [
              /* @__PURE__ */ jsx4("span", { className: "flex items-center justify-center w-6 h-6 rounded border border-border bg-background text-muted-foreground shrink-0", children: item.icon }),
              /* @__PURE__ */ jsx4("span", { className: "text-sm font-medium", children: item.label })
            ]
          },
          item.label
        ))
...
import {
  ...
  ArrowRightToLine,
  Trash2 as Trash23,
  PanelTop as PanelTop2,
  PanelLeft as PanelLeft2,
  Combine as Combine2,
  SplitSquareHorizontal as SplitSquareHorizontal2,
...
import { useState as useState5, useEffect as useEffect5, useRef as useRef5, useCallback as useCallback3 } from "react";
...
function TBtn({
  ...
  return /* @__PURE__ */ jsxs5("div", { className: "hce-table-btn-wrap", children: [
    /* @__PURE__ */ jsx5(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsx5("span", { className: "hce-table-btn-tooltip", children: label })
  ] });
}
...
function TableBubbleMenu({ editor }) {
  ...
  const [pos, setPos] = useState5({ top: 0, left: 0, width: 0 });
  const [showColors, setShowColors] = useState5(false);
  const [showLineHeight, setShowLineHeight] = useState5(false);
  ...
  return /* @__PURE__ */ jsx5(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxs5("div", { className: "flex items-center justify-center gap-0.5 px-1.5 py-1 bg-foreground rounded-lg shadow-xl w-fit mx-auto", children: [
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            disabled: !editor.can().addRowBefore(),
            label: "\uD589 \uC704\uC5D0 \uCD94\uAC00",
            children: /* @__PURE__ */ jsx5(ArrowUpToLine, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            disabled: !editor.can().addRowAfter(),
            label: "\uD589 \uC544\uB798\uC5D0 \uCD94\uAC00",
            children: /* @__PURE__ */ jsx5(ArrowDownToLine, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            disabled: !editor.can().addColumnBefore(),
            label: "\uC5F4 \uC67C\uCABD\uC5D0 \uCD94\uAC00",
            children: /* @__PURE__ */ jsx5(ArrowLeftToLine, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            disabled: !editor.can().addColumnAfter(),
            label: "\uC5F4 \uC624\uB978\uCABD\uC5D0 \uCD94\uAC00",
            children: /* @__PURE__ */ jsx5(ArrowRightToLine, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5("div", { className: "w-px h-5 bg-white/20 mx-0.5" }),
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            disabled: !editor.can().toggleHeaderRow(),
            label: "\uD5E4\uB354 \uD589 \uD1A0\uAE00",
            children: /* @__PURE__ */ jsx5(PanelTop2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            disabled: !editor.can().toggleHeaderColumn(),
            label: "\uD5E4\uB354 \uC5F4 \uD1A0\uAE00",
            children: /* @__PURE__ */ jsx5(PanelLeft2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            disabled: !editor.can().mergeCells(),
            label: "\uC140 \uBCD1\uD569",
            children: /* @__PURE__ */ jsx5(Combine2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            disabled: !editor.can().splitCell(),
            label: "\uC140 \uBD84\uD560",
            children: /* @__PURE__ */ jsx5(SplitSquareHorizontal2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5("div", { className: "w-px h-5 bg-white/20 mx-0.5" }),
        /* @__PURE__ */ jsxs5("div", { className: "relative", children: [
          /* @__PURE__ */ jsx5(
            TBtn,
            {
              ...
              label: "\uC904 \uAC04\uACA9",
              children: /* @__PURE__ */ jsx5(UnfoldVertical, { size: iconSize })
            }
          ),
          showLineHeight && /* @__PURE__ */ jsx5("div", { className: "absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-foreground rounded-lg shadow-xl border border-white/10 py-1", style: { minWidth: "100px" }, children: LINE_HEIGHTS.map((lh) => /* @__PURE__ */ jsx5(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            label: "\uB108\uBE44 \uB3D9\uC77C",
            children: /* @__PURE__ */ jsx5(EqualApproximately, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsxs5("div", { className: "relative", children: [
          /* @__PURE__ */ jsx5(
            TBtn,
            {
              ...
              label: "\uC140 \uBC30\uACBD\uC0C9",
              children: /* @__PURE__ */ jsx5(Paintbrush2, { size: iconSize })
            }
          ),
          showColors && /* @__PURE__ */ jsxs5("div", { className: "absolute bottom-full left-1/2 -translate-x-1/2 mb-2 bg-foreground rounded-lg shadow-xl border border-white/10 p-2", style: { minWidth: "160px" }, children: [
            /* @__PURE__ */ jsx5("p", { className: "text-[10px] font-medium text-white/50 uppercase tracking-wider mb-1.5 px-1", children: "\uBC30\uACBD\uC0C9" }),
            /* @__PURE__ */ jsx5("div", { className: "grid grid-cols-3 gap-1", children: PRESET_COLORS.map((c) => /* @__PURE__ */ jsx5(
              "button",
              {
                type: "button",
                title: c.label,
        ...
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            destructive: true,
            label: "\uD589 \uC0AD\uC81C",
            children: /* @__PURE__ */ jsx5(RowsIcon, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            destructive: true,
            label: "\uC5F4 \uC0AD\uC81C",
            children: /* @__PURE__ */ jsx5(ColumnsIcon, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx5(
          TBtn,
          {
            ...
            destructive: true,
            label: "\uD45C \uC0AD\uC81C",
            children: /* @__PURE__ */ jsx5(Trash23, { size: iconSize })
          }
        )
      ] })
    }
...
function TipTapEditor({
  ...
  const pdfInputRef = useRef6(null);
  ...
  const [slashMenuPos, setSlashMenuPos] = useState6({ top: 0, left: 0 });
  const [slashMenuDirection, setSlashMenuDirection] = useState6("down");
  const [slashQuery, setSlashQuery] = useState6("");
  const slashStartPos = useRef6(null);
  const MENU_HEIGHT = 210;
  const updateSlashMenuPosition = useCallback4(() => {
  ...
  return /* @__PURE__ */ jsxs6("div", { className: "hce-editor-wrapper relative border border-border rounded-xl bg-background", children: [
    /* @__PURE__ */ jsx6(FixedToolbar, { editor, onPdfClick: () => pdfInputRef.current?.click() }),
    /* @__PURE__ */ jsx6(EditorContent, { editor }),
    /* @__PURE__ */ jsx6(TableBubbleMenu, { editor }),
    uploading && /* @__PURE__ */ jsx6("div", { className: "absolute inset-0 flex items-center justify-center bg-background/60 rounded-xl", children: /* @__PURE__ */ jsx6("p", { className: "text-sm text-muted-foreground animate-pulse", children: "\uC5C5\uB85C\uB4DC \uC911..." }) }),
    slashMenuOpen && /* @__PURE__ */ jsx6(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs6("div", { className: "flex justify-end px-4 py-2 text-xs text-muted-foreground border-t border-border", children: [
...
import {
  ...
  Heading2 as Heading23,
  Heading3 as Heading33,
  Type
} from "lucide-react";
...
function BubbleDivider() {
  return /* @__PURE__ */ jsx7("div", { className: "w-px h-5 bg-white/20 mx-0.5" });
}
function BubbleToolbar({ editor }) {
  const [showHeadings, setShowHeadings] = useState7(false);
  const iconSize = 14;
  const addLink = useCallback5(() => {
  ...
  return /* @__PURE__ */ jsx7(
    BubbleMenu,
    {
      ...
      children: /* @__PURE__ */ jsxs7("div", { className: "flex items-center gap-0.5 px-1.5 py-1 bg-foreground rounded-lg shadow-xl", children: [
        /* @__PURE__ */ jsxs7("div", { className: "relative", children: [
          /* @__PURE__ */ jsxs7(
            "button",
            {
              ...
              children: [
                /* @__PURE__ */ jsx7(Type, { size: 12 }),
                getCurrentBlockLabel()
              ]
            }
          ),
          showHeadings && /* @__PURE__ */ jsxs7("div", { className: "absolute bottom-full left-0 mb-1 bg-foreground rounded-lg shadow-xl border border-white/10 py-1 min-w-[120px]", children: [
            /* @__PURE__ */ jsxs7(
              "button",
              {
                type: "button",
            ...
            [1, 2, 3].map((level) => {
              const Icon = level === 1 ? Heading13 : level === 2 ? Heading23 : Heading33;
        ...
        /* @__PURE__ */ jsx7(
          BubbleButton,
          {
            ...
            active: editor.isActive("bold"),
            title: "\uAD75\uAC8C",
            children: /* @__PURE__ */ jsx7(Bold2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx7(
          BubbleButton,
          {
            ...
            active: editor.isActive("italic"),
            title: "\uAE30\uC6B8\uC784",
            children: /* @__PURE__ */ jsx7(Italic2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx7(
          BubbleButton,
          {
            ...
            active: editor.isActive("underline"),
            title: "\uBC11\uC904",
            children: /* @__PURE__ */ jsx7(UnderlineIcon2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx7(
          BubbleButton,
          {
            ...
            active: editor.isActive("strike"),
            title: "\uCDE8\uC18C\uC120",
            children: /* @__PURE__ */ jsx7(Strikethrough2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx7(
          BubbleButton,
          {
            ...
            active: editor.isActive("highlight"),
            title: "\uD558\uC774\uB77C\uC774\uD2B8",
            children: /* @__PURE__ */ jsx7(Highlighter2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx7(BubbleDivider, {}),
        /* @__PURE__ */ jsx7(
          BubbleButton,
          {
            ...
            title: "\uB9C1\uD06C",
            children: /* @__PURE__ */ jsx7(LinkIcon3, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx7(BubbleDivider, {}),
        /* @__PURE__ */ jsx7(
          BubbleButton,
          {
            ...
            active: editor.isActive({ textAlign: "left" }),
            title: "\uC67C\uCABD \uC815\uB82C",
            children: /* @__PURE__ */ jsx7(AlignLeft2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx7(
          BubbleButton,
          {
            ...
            active: editor.isActive({ textAlign: "center" }),
            title: "\uAC00\uC6B4\uB370 \uC815\uB82C",
            children: /* @__PURE__ */ jsx7(AlignCenter2, { size: iconSize })
          }
        ),
        /* @__PURE__ */ jsx7(
          BubbleButton,
          {
            ...
            active: editor.isActive({ textAlign: "right" }),
            title: "\uC624\uB978\uCABD \uC815\uB82C",
            children: /* @__PURE__ */ jsx7(AlignRight2, { size: iconSize })
          }
        )
      ] })
    }
...
function PdfViewer({ src, fileName }) {
  ...
  const [pdf, setPdf] = useState8(null);
  const [page, setPage] = useState8(1);
  const [total, setTotal] = useState8(0);
  const [loading2, setLoading] = useState8(true);
  ...
  const renderingRef = useRef7(false);
  ...
  if (error) {
    return /* @__PURE__ */ jsxs8("div", { className: "border border-border rounded-lg p-4 text-center", children: [
      /* @__PURE__ */ jsx8("p", { className: "text-sm text-muted-foreground", children: "PDF\uB97C \uBD88\uB7EC\uC62C \uC218 \uC5C6\uC2B5\uB2C8\uB2E4." }),
      /* @__PURE__ */ jsx8("a", { href: src, target: "_blank", rel: "noopener noreferrer", className: "text-sm text-primary hover:underline", children: "\uC9C1\uC811 \uB2E4\uC6B4\uB85C\uB4DC" })
    ] });
  }
  if (loading2) {
    return /* @__PURE__ */ jsx8("div", { className: "border border-border rounded-lg p-8 text-center", children: /* @__PURE__ */ jsx8("p", { className: "text-sm text-muted-foreground animate-pulse", children: "PDF \uB85C\uB529 \uC911..." }) });
  }
  return /* @__PURE__ */ jsxs8("div", { className: "border border-border rounded-lg overflow-hidden bg-muted/30 my-4", children: [
    /* @__PURE__ */ jsxs8("div", { className: "flex items-center justify-between px-4 py-2 border-b border-border bg-background", children: [
      /* @__PURE__ */ jsx8("span", { className: "text-xs text-muted-foreground truncate", children: fileName || "PDF \uBB38\uC11C" }),
      /* @__PURE__ */ jsxs8("span", { className: "text-xs text-muted-foreground tabular-nums", children: [
        page,
        " / ",
        total
      ] })
    ] }),
    /* @__PURE__ */ jsx8("div", { ref: containerRef, className: "flex items-center justify-center p-4 bg-neutral-100 dark:bg-neutral-900", children: /* @__PURE__ */ jsx8("canvas", { ref: canvasRef, className: "shadow-sm" }) }),
    total > 1 && /* @__PURE__ */ jsxs8("div", { className: "flex items-center justify-center gap-4 px-4 py-2 border-t border-border bg-background", children: [
      /* @__PURE__ */ jsx8(
        "button",
        {
          type: "button",
          ...
          className: "p-1.5 rounded hover:bg-muted transition-colors disabled:opacity-30",
          title: "\uC774\uC804 \uD398\uC774\uC9C0",
          children: /* @__PURE__ */ jsx8(ChevronLeft2, { className: "w-4 h-4" })
        }
      ),
      /* @__PURE__ */ jsxs8("span", { className: "text-sm tabular-nums", children: [
        page,
        " / ",
        total
      ] }),
