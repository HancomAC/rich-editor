...
describe("toEmbedUrl", () => {
    ...
    it("shorts·live 도 같은 임베드 주소가 된다", () => {
        expect(toEmbedUrl("https://www.youtube.com/shorts/abc12345678")).toBe("https://www.youtube.com/embed/abc12345678");
        expect(toEmbedUrl("https://www.youtube.com/live/abc12345678")).toBe("https://www.youtube.com/embed/abc12345678");
    });
    it("모바일·뮤직·nocookie 호스트도 알아본다", () => {
        expect(toEmbedUrl("https://m.youtube.com/watch?v=abc12345678")).toBe("https://www.youtube.com/embed/abc12345678");
        expect(toEmbedUrl("https://music.youtube.com/watch?v=abc12345678")).toBe("https://www.youtube.com/embed/abc12345678");
    });
    it("타임스탬프를 start 초로 옮긴다", () => {
        expect(toEmbedUrl("https://youtu.be/abc12345678?t=90")).toBe("https://www.youtube.com/embed/abc12345678?start=90");
        // `1m30s` 꼴도 같은 90초여야 한다
        expect(toEmbedUrl("https://www.youtube.com/watch?v=abc12345678&t=1m30s")).toBe("https://www.youtube.com/embed/abc12345678?start=90");
        expect(toEmbedUrl("https://youtu.be/abc12345678?t=1h2m3s")).toBe("https://www.youtube.com/embed/abc12345678?start=3723");
    });
    it("재생목록은 유지한다", () => {
        expect(toEmbedUrl("https://www.youtube.com/watch?v=abc12345678&list=PL123")).toBe("https://www.youtube.com/embed/abc12345678?list=PL123");
    });
    it("이미 임베드 주소면 그대로 둔다", () => {
        expect(toEmbedUrl("https://www.youtube.com/embed/abc12345678")).toBe("https://www.youtube.com/embed/abc12345678");
    });
    it("Vimeo 를 플레이어 주소로 바꾼다", () => {
        expect(toEmbedUrl("https://vimeo.com/123456789")).toBe("https://player.vimeo.com/video/123456789");
        expect(toEmbedUrl("https://vimeo.com/channels/staffpicks/123456789")).toBe("https://player.vimeo.com/video/123456789");
        // 이미 플레이어 주소면 손대지 않는다
