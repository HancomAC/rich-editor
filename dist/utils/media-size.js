...
export function normalizeMediaAlign(value) {
    if (typeof value !== "string")
        return null;
    const normalized = value.trim().toLowerCase();
    return ALIGN_VALUES.includes(normalized)
        ? normalized
        : null;
}
/**
 ...
 */
export function normalizeMediaHeight(value) {
    if (value == null)
        return null;
 ...
 */
export function normalizeMediaRatio(value) {
    if (typeof value === "number") {
...
export function mediaRatioValue(value) {
...
export function mediaRatioCss(value) {
    const canonical = normalizeMediaRatio(value);
    if (!canonical)
        return null;
