...
/** 후보 최대 수 — main 과 같다. */
export declare const EMOJI_SUGGESTION_MAX = 10;
/**
 ...
 * (`:x `, `::`) 판정이 끝난 것으로 본다.
 */
export declare const EMOJI_QUERY_REGEX: RegExp;
/** 키워드에 `:query`(소문자화)가 들어가는 이모지를 앞에서부터 최대 `max`개. */
export declare function searchEmojis(query: string, max?: number): EmojiSuggestion[];
/**
 ...
 */
export declare function findEmojiQuery(state: EditorState): EmojiQueryMatch | null;
