...
import { isEmptyRootParagraph, floatingHelperVisible, helperInsertMath, helperInsertCodeBlock, FLOATING_HELPER_ON_CLASS, } from "./floating-helper";
/*
...
describe("빈 줄 플로팅 헬퍼", () => {
    let editor;
    function createEditor(content = "<p></p>", opts = {}) {
        editor = new Editor({
